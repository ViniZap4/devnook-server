...
func main() {
	...
	r.Route("/api/v1", func(r chi.Router) {
		...
		// Documentation
		r.Get("/docs/spaces", h.ListDocSpaces)
		r.Post("/docs/spaces", h.CreateDocSpace)
		r.Get("/docs/spaces/{spaceSlug}", h.GetDocSpace)
		r.Put("/docs/spaces/{spaceSlug}", h.UpdateDocSpace)
		r.Delete("/docs/spaces/{spaceSlug}", h.DeleteDocSpace)
		r.Get("/docs/spaces/{spaceSlug}/pages", h.ListDocPages)
		r.Post("/docs/spaces/{spaceSlug}/pages", h.CreateDocPage)
		r.Get("/docs/spaces/{spaceSlug}/pages/{pageSlug}", h.GetDocPage)
		r.Put("/docs/spaces/{spaceSlug}/pages/{pageSlug}", h.UpdateDocPage)
		r.Delete("/docs/spaces/{spaceSlug}/pages/{pageSlug}", h.DeleteDocPage)
		r.Get("/docs/spaces/{spaceSlug}/pages/{pageSlug}/versions", h.ListDocPageVersions)

		// Projects
		r.Get("/projects", h.ListProjects)
		r.Post("/projects", h.CreateProject)
		r.Get("/projects/{projectSlug}", h.GetProject)
		r.Put("/projects/{projectSlug}", h.UpdateProject)
		r.Delete("/projects/{projectSlug}", h.DeleteProject)
		r.Get("/projects/{projectSlug}/members", h.ListProjectMembers)
		r.Post("/projects/{projectSlug}/members", h.AddProjectMember)
		r.Put("/projects/{projectSlug}/members/{username}", h.UpdateProjectMemberRole)
		r.Delete("/projects/{projectSlug}/members/{username}", h.RemoveProjectMember)
		r.Get("/projects/{projectSlug}/repos", h.ListProjectRepos)
		r.Post("/projects/{projectSlug}/repos", h.LinkProjectRepo)
		r.Delete("/projects/{projectSlug}/repos/{repoId}", h.UnlinkProjectRepo)
		r.Get("/projects/{projectSlug}/columns", h.ListProjectColumns)
		r.Post("/projects/{projectSlug}/columns", h.CreateProjectColumn)
		r.Put("/projects/{projectSlug}/columns/{columnId}", h.UpdateProjectColumn)
		r.Delete("/projects/{projectSlug}/columns/{columnId}", h.DeleteProjectColumn)
		r.Put("/projects/{projectSlug}/columns/reorder", h.ReorderProjectColumns)
		r.Get("/projects/{projectSlug}/swimlanes", h.ListProjectSwimlanes)
		r.Post("/projects/{projectSlug}/swimlanes", h.CreateProjectSwimlane)
		r.Put("/projects/{projectSlug}/swimlanes/{swimlaneId}", h.UpdateProjectSwimlane)
		r.Delete("/projects/{projectSlug}/swimlanes/{swimlaneId}", h.DeleteProjectSwimlane)

		// Project Sprints
		r.Get("/projects/{projectSlug}/sprints", h.ListProjectSprints)
		r.Post("/projects/{projectSlug}/sprints", h.CreateProjectSprint)
		r.Get("/projects/{projectSlug}/sprints/{sprintId}", h.GetProjectSprint)
		r.Put("/projects/{projectSlug}/sprints/{sprintId}", h.UpdateProjectSprint)
		r.Delete("/projects/{projectSlug}/sprints/{sprintId}", h.DeleteProjectSprint)
		r.Post("/projects/{projectSlug}/sprints/{sprintId}/start", h.StartProjectSprint)
		r.Post("/projects/{projectSlug}/sprints/{sprintId}/complete", h.CompleteProjectSprint)

		// Project Items & Board
		r.Get("/projects/{projectSlug}/items", h.ListProjectItems)
		r.Post("/projects/{projectSlug}/items", h.CreateProjectItem)
		r.Get("/projects/{projectSlug}/items/{itemId}", h.GetProjectItem)
		r.Put("/projects/{projectSlug}/items/{itemId}", h.UpdateProjectItem)
		r.Delete("/projects/{projectSlug}/items/{itemId}", h.DeleteProjectItem)
		r.Put("/projects/{projectSlug}/items/{itemId}/move", h.MoveProjectItem)
		r.Get("/projects/{projectSlug}/items/{itemId}/history", h.GetProjectItemHistory)
		r.Get("/projects/{projectSlug}/board", h.GetProjectBoard)

		// Calendar
		r.Get("/calendar/events", h.ListCalendarEvents)
		r.Post("/calendar/events", h.CreateCalendarEvent)
		r.Get("/calendar/events/{eventId}", h.GetCalendarEvent)
		r.Put("/calendar/events/{eventId}", h.UpdateCalendarEvent)
		r.Delete("/calendar/events/{eventId}", h.DeleteCalendarEvent)
		r.Post("/calendar/events/{eventId}/rsvp", h.UpdateCalendarRSVP)
		r.Get("/calendar/unified", h.GetUnifiedCalendar)
